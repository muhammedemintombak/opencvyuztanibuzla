...
input("""Yazılım bir görüntü kaynağındaki yüzleri tespit ederek işaretlemektedir.
...
if int(secim_kaynak)==1:
    ...
    kok = Tk()
    kok.dosyaYolu =  filedialog.askopenfilename(initialdir = "/", title = "video dosyasını seçiniz", 
